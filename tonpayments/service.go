...
func (s *Service) GetMinSafeTTL() time.Duration {
	return time.Duration(s.cfg.MinSafeVirtualChannelTimeoutSec+s.cfg.BufferTimeToCommit+s.cfg.ConditionalCloseDurationSec+s.cfg.QuarantineDurationSec+s.cfg.ActionsDuration) * time.Second
}
